...
--
-- Host: localhost
-- Generation Time: Nov 29, 2023 at 02:59 AM
...
CREATE TABLE `order` (
  ...
  `special_dietary_requirements` varchar(1024) NOT NULL,
  `any_allergy` varchar(1024) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `restaurant_reviews` (
  ...
  `overall_experience` int(11) NOT NULL
