...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2023 at 08:04 AM
...
INSERT INTO `order` (`id`, `date_time`, `menu_id`, `ingredients`, `preparation_instructions`, `user_id`, `order_status`, `special_dietary_requirements`, `any_allergy`, `price`) VALUES
(1, '2023-12-03 21:37', 1, '', 'Cook well', 6, 2, 'Olives', 'Wheat', 1190),
(2, '2023-12-04 00:31', 1, '', 'Cook on medium flame.', 6, 1, 'Add olives.', 'Avoid white flour.', 1190),
(3, '2023-12-10 13:01', 1, '', 'Cook on medium flame', 6, 1, 'Avoid red chilli', 'No', 1190);
...
INSERT INTO `restaurant_reviews` (`id`, `restaurant_id`, `feedback`, `rating`, `delivery_service`, `overall_experience`) VALUES
(1, 1, 'Food was great. Neat and clean environment.', 4, 4, 4),
(2, 1, 'This restaurant offers wide range of BBQ. We loved their seekh kababs. ', 5, 3, 4);
